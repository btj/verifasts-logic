...
\begin{figure}
$$\begin{array}{r @{\;} l}
& t \in \mathcal{T}, p \in \mathcal{P}, g \in \mathcal{G}, \pi \in \mathbb{R}^+\\
E ::= & z\ |\ x\ |\ g\ |\ E + E\ |\ p(\overline{E})\ |\ (E, E)\ |\ ()\ |\ \emptyset\ |\ \{E\}\ |\ E \cup E\\
a ::= & [\pi]E \mapsto E\ |\ [\pi]E \gmapsto E\ |\ E()\ |\ [\pi]\mathbf{atomic\_space}(E, E)\ |\ E : t(\overline{E})\\
| & \exists g.\;a\ |\ \mathbf{atomic\_spaces}(E)\\
\mathit{gdecl} ::= & \mathbf{lem\_type}\ t(\overline{g}) = \mathbf{lem}(\overline{g})\ \mathbf{forall}\ \overline{g}\ \mathbf{req}\ a\ \mathbf{ens}\ a\\
| & \mathbf{pred\_ctor}\ p(\overline{g})() = a\\
C ::= & c\ |\ \mathbf{let}\ x = c\ \mathbf{in}\ C\ |\ \mathbf{glet}\ g = C\ \mathbf{in}\ C\ |\ E(\overline{E})\\
| & \mathbf{gcons}(E)\ |\ {*}E \leftarrow_\mathsf{g} E\\
| & \mathbf{open}\ E()\ |\ \mathbf{close}\ E()\\
| & \mathbf{create\_atomic\_space}(E, E)\ |\ \mathbf{destroy\_atomic\_space}(E, E)\\
| & \mathbf{open\_atomic\_space}(E, E)\ |\ \mathbf{close\_atomic\_space}(E, E)\\
| & \mathbf{produce\_lem\_ptr\_chunk}\ t(\overline{E})(\overline{g})\ \{\ C\ \}\\
\end{array}$$
